...
public class WorkflowTaskHandler {
   ...
   * interrupting boundary event, the end of the workflow or the application's own
   * {@code cancelTask} removed it. A method without a {@code @TaskEvent} parameter never
  ...
  /**
   * Called by VanillaBP on the path the error boundary event leads to.
   *
   * @param loanApproval The workflow's aggregate.
   */
  @WorkflowTask
  public void noteRejection(
    ...
    service.noteRejection(loanApproval);
