...
public class ApiController {
  ...
  /**
   * The partner's answer, which completes the waiting task or cancels it by BPMN error.
   *
   ...
   */
  @GetMapping("/{loanRequestId}/partner-decision/{taskId}")
  public String partnerDecision(
