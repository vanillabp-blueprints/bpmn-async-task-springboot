...
public class Aggregate {
   ...
   * task was delivered. It is the handle needed to complete or cancel that task, and it
   * is null whenever nothing is waiting.
   */
  @Column
  private String partnerApprovalTaskId;

  /** What the partner answered, written when their answer arrives. */
  @Column
  ...
  /** Written by the service task the error boundary event leads to. */
  @Column
